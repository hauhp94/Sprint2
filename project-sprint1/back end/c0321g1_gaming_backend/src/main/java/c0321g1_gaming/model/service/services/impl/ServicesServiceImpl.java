...
public class ServicesServiceImpl implements IServicesService {
    ...
    public void save(Services services) {
        ...
        servicesRepository.saveServices(services.getCode(),services.getFlag(),services.getImage(),services.getName().trim(),services.getPrices(),services.getQuantity(),services.getUnit().getUnitId());
    }
    ...
    public void update(Services services) {
        ...
        services.setCode(code);
        servicesRepository.updateServices(services.getCode(),services.getFlag(),services.getImage(),services.getName().trim(),services.getPrices(),
    ...
    @Override
    public Services findByIdServices(Long id) {
