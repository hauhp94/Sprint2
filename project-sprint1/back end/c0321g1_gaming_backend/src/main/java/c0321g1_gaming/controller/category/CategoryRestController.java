...
public class CategoryRestController {
    ...
    @PatchMapping("addMoneyToAccount/{moneyBuyHour}")
    public ResponseEntity<Void> addMoneyToAccount(@RequestBody Category category,@PathVariable Integer moneyBuyHour) {
        categoryService.addMoneyAccount(category, moneyBuyHour);
        return new ResponseEntity<>(HttpStatus.OK);
    }
}
